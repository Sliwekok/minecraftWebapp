...
class ServerUnixCommandsInterface
{
    ...
    public const REPLACEMENT_JAVA = '{java}';
    ...
    public const RUN_SERVER = 'sudo '. self::REPLACEMENT_JAVA .' -Xmx'. self::REPLACEMENT_RAM. 'G -jar '. self::REPLACEMENT_PATH. '/server.jar --nogui';
